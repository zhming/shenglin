...
<td height="39" style="padding-left:2px;">
                                                ...
                                                <tr>
                                                    <td height="31" style="border-bottom:#999999 1px dashed;">
                                                        <img src="/shenglin/images/guide.gif"/>&nbsp;&nbsp;<a
                                                            href="product.html?ID=${product.id}" style="color:#666"
                                                    ...
                                                    <td align="right" height="31"
                                                        ...
                                                        &nbsp;&nbsp;<a href="updateProduct.html?ID=${product.id}">修改</a>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
  ...
  <font face=webdings>7</font>
                                                    ...
                                                    <select onChange="if(this.value!='')location.href=this.value;">
                                                        ...
                                                        <option value="?SortID=100&ClassID=&CurPage=1&Type3=3" selected>
                                                            1
                                                        </option>

                                                        <option value="?SortID=100&ClassID=&CurPage=2&Type3=3">2
                                                        </option>

                                                        <option value="?SortID=100&ClassID=&CurPage=3&Type3=3">3
                                                        </option>

                                                        <option value="?SortID=100&ClassID=&CurPage=4&Type3=3">4
                                                        </option>

                                                        <option value="?SortID=100&ClassID=&CurPage=5&Type3=3">5
                                                        </option>

                                                        <option value="?SortID=100&ClassID=&CurPage=6&Type3=3">6
                                                        </option>

                                                        <option value="?SortID=100&ClassID=&CurPage=7&Type3=3">7
                                                        </option>

                                                        <option value="?SortID=100&ClassID=&CurPage=8&Type3=3">8
                                                        </option>

                                                        <option value="?SortID=100&ClassID=&CurPage=9&Type3=3">9
                                                        </option>

                                                        <option value="?SortID=100&ClassID=&CurPage=10&Type3=3">10
                                                        </option>

                                                        <option value="?SortID=100&ClassID=&CurPage=11&Type3=3">11
                                                        </option>

                                                        <option value="?SortID=100&ClassID=&CurPage=12&Type3=3">12
                                                        </option>

                                                        <option value="?SortID=100&ClassID=&CurPage=13&Type3=3">13
                                                        </option>

                                                        <option value="?SortID=100&ClassID=&CurPage=14&Type3=3">14
                                                        </option>

                                                        <option value="?SortID=100&ClassID=&CurPage=15&Type3=3">15
                                                        </option>

                                                        <option value="?SortID=100&ClassID=&CurPage=16&Type3=3">16
                                                        </option>

                                                        <option value="?SortID=100&ClassID=&CurPage=17&Type3=3">17
                                                        </option>

                                                        <option value="?SortID=100&ClassID=&CurPage=18&Type3=3">18
                                                        </option>

                                                        <option value="?SortID=100&ClassID=&CurPage=19&Type3=3">19
                                                        </option>

                                                        <option value="?SortID=100&ClassID=&CurPage=20&Type3=3">20
                                                        </option>

                                                        <option value="?SortID=100&ClassID=&CurPage=21&Type3=3">21
                                                        </option>

                                                        <option value="?SortID=100&ClassID=&CurPage=22&Type3=3">22
                                                        </option>

                                                        <option value="?SortID=100&ClassID=&CurPage=23&Type3=3">23
                                                        </option>

                                                        <option value="?SortID=100&ClassID=&CurPage=24&Type3=3">24
                                                        </option>

                                                        <option value="?SortID=100&ClassID=&CurPage=25&Type3=3">25
                                                        </option>

                                                        <option value="?SortID=100&ClassID=&CurPage=26&Type3=3">26
                                                        </option>

                                                        <option value="?SortID=100&ClassID=&CurPage=27&Type3=3">27
                                                        </option>

                                                        <option value="?SortID=100&ClassID=&CurPage=28&Type3=3">28
                                                        </option>

                                                        <option value="?SortID=100&ClassID=&CurPage=29&Type3=3">29
                                                        </option>

                                                        <option value="?SortID=100&ClassID=&CurPage=30&Type3=3">30
                                                        </option>

                                                        <option value="?SortID=100&ClassID=&CurPage=31&Type3=3">31
                                                        </option>

                                                        <option value="?SortID=100&ClassID=&CurPage=32&Type3=3">32
                                                        </option>

                                                        <option value="?SortID=100&ClassID=&CurPage=33&Type3=3">33
                                                        </option>

                                                        <option value="?SortID=100&ClassID=&CurPage=34&Type3=3">34
                                                        </option>

                                                        <option value="?SortID=100&ClassID=&CurPage=35&Type3=3">35
                                                        </option>

                                                        <option value="?SortID=100&ClassID=&CurPage=36&Type3=3">36
                                                        </option>

                                                        <option value="?SortID=100&ClassID=&CurPage=37&Type3=3">37
                                                        </option>

                                                        <option value="?SortID=100&ClassID=&CurPage=38&Type3=3">38
                                                        </option>

                                                        <option value="?SortID=100&ClassID=&CurPage=39&Type3=3">39
                                                        </option>
