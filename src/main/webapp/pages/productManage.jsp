...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%= basePath%><%= basePath%>Pic/Style.css">
    <link rel="stylesheet" type="text/css" href="<%= basePath%><%= basePath%>Js/index.css">
    <script language="javascript" src="<%= basePath%><%= basePath%>Pic/FlashView.js"></script>
    <script language="javascript" src="<%= basePath%><%= basePath%>Pic/ImgSize.js"></script>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    <noscript>
            ...
            <table width="978" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td width="775" height="71" background="<%= basePath%>images/navBack.jpg">
                        ...
                        <div class="Divone"><a href="<%= basePath%><%= basePath%>WEB-INF/pages/Product.jsp">产品展示</a>
                        </div>
